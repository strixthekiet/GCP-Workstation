...
resource "google_compute_instance" "jellyfin_server" {
  ...
  #     "sudo ufw allow 8096",
  #     "chmod +x /home/${local.os_login_user}/setup-mount.sh && sudo /home/${local.os_login_user}/setup-mount.sh /media ${data.google_compute_disk.media_pd.name}",
  ...
  #     "sudo apt install qbittorrent-nox -y", # && qbittorrent-nox -d",
